...
#define IN1 2 //Kopplad till Pin10/ 
#define IN2 3 //Kopplad till Pin11/ PORTB2
#define IN1_ON PORTB |= (1 << IN1) //Använder bitvis skiftning för att tända diodern.
#define IN1_OFF PORTB &= ~(1 << IN1) //Bitvis multiplikation med negation för att släcka diodern.++
